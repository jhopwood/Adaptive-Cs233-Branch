...
function domloaded(){
    ...
    qx.font="17px Arial";
    qx.fillText("Which of the following actions do Processor 1 and Processor 2 take?",30,253);
	
	var q1=document.getElementById("myCanvas");
    var q1x=q1.getContext("2d");
    q1x.font="italic 17px Arial";
    q1x.fillText("Assume that variables A, B, C all exist in different cache blocks that can fit in the cache simultaneously",90,275);
